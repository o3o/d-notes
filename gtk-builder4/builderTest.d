...
int main(string[] args) {
   ...
   return createApp(gladefile).run(args);
}

Application createApp(string gladefile) {
   Application application = new Application("org.gtkd.demo.builder.builderTest", GApplicationFlags.FLAGS_NONE);
